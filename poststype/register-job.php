...
function job_filter_ajax_handler() {
    ...
    if ( $jobs_query->have_posts() ) {
        ...
        echo '<p class="no-results">Désolé, aucune offre ne correspond à vos critères.</p>';
    }
...
if ( ! is_wp_error( $new_post_id ) ) {
        ...
        $raw_admin_body    = get_option('job_admin_email_body', 'Bonjour, je suis un nouveau candidat.');
        ...
        wp_send_json_success( array( 'message' => 'Votre candidature a été transmise avec succès.' ) );
    } else {
...
function job_app_email_settings_callback() {
    ...
    if ( isset($_POST['save_email_templates']) ) {
        ...
        echo '<div class="updated"><p>Die Einstellungen wurden erfolgreich gespeichert!</p></div>';
    }
