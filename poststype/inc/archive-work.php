...
if ( ! function_exists( 'work_render_single_card' ) ) {
    function work_render_single_card( $post_id ) {
        // Cung cấp hàm hiển thị dự phòng nếu hàm gốc không được tìm thấy
        $client_info = get_post_meta( $post_id, '_work_client', true );
...
<div class="container work-archive-container">

    <header class="page-header">
        <h1 class="page-title"><?php post_type_archive_title( 'work Listings: ' ); ?></h1>
    </header>

    <div id="primary" class="content-area">
        <main id="main" class="site-main work-results-wrapper" role="main">

            <?php if ( have_posts() ) : ?>

                <div class="work-grid archive-work-grid">
                    <?php 
                    // Bắt đầu The Loop (WordPress sẽ tự động query các bài 'work')
                    while ( have_posts() ) : the_post(); 
                        work_render_single_card( get_the_ID() );
                    endwhile; 
                    ?>
                </div>
                ...
                <div class="archive-pagination">
                    ...
                    the_posts_pagination( array(
                        ...
                        'screen_reader_text' => 'work Pagination'
                    ) );
                    ?>
                </div>
            ...
            <?php else : ?>
                ...
                <p class="no-results">Sorry, no works found.</p>
