...
final class ThemesFlat_Addon_For_Elementor_proty {
    ...
    public function init_widgets() {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFImage_slider_Widget() ); 
   ...
   public function widget_scripts() {
    ...
    wp_register_script( 'jquery-validate', plugins_url( '/assets/js/jquery-validate.js', __FILE__ ), [ 'jquery' ], null, true );
    wp_register_script( 'nice-select', plugins_url( '/assets/js/jquery.nice-select.min.js', __FILE__ ), [ 'jquery' ], null, true );
            ...
            <td class="tfhf-options-row-content">
                <select name="tfhf_template_type" id="tfhf_template_type">
                    <option value="" <?php selected( $template_type, '' ); ?>>
                        <?php esc_html_e( 'Select Option', 'themesflat-core' ); ?></option>
                    <option value="type_header" <?php selected( $template_type, 'type_header' ); ?>>
                        <?php esc_html_e( 'Header', 'themesflat-core' ); ?></option>
                    <option value="type_footer" <?php selected( $template_type, 'type_footer' ); ?>>
                        <?php esc_html_e( 'Footer', 'themesflat-core' ); ?></option>
                </select>
            </td>
        </tr>
