...
<div class="section-about flat-spacing">
    ...
    <?php if ( ! empty( $settings['award_list'] ) ) : ?>
    <ul class="award-list">
        ...
        <li class="award-item hover-cursor-img elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?>">
            <div class="left">
                <h6 class="award_name letter-space--2 text-black-72"><?php echo esc_html( $item['award_name'] ); ?></h6>
                <p class="award_desc text-black-56"><?php echo esc_html( $item['award_org'] ); ?></p>
            </div>
            <h6 class="award_year text-black-72"><?php echo esc_html( $item['award_year'] ); ?></h6>
            <?php if ( ! empty( $item['award_image']['url'] ) ) : ?>
            <div class="award_img hover-image">
                <img loading="lazy" width="158" height="224" src="<?php echo esc_url( $item['award_image']['url'] ); ?>"
