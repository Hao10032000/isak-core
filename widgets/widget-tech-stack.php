...
class TFTech_Stack_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $repeater->add_control('item_image', [
            'label' => esc_html__( 'Icon/Image', 'themesflat-core' ),
...
<div class="section-tech-stack flat-spacing">
    ...
    <ul class="tech-list">
        ...
        <li class="wg-tech">
            <div class="tech-infor effectFade fadeUp no-div">
                <div class="tech_image">
                    ...
                    <img src="<?php echo esc_url( $item['item_image']['url'] ); ?>" width="18" height="28"
            ...
            <div class="tech-progress">
                <div class="progress-line" data-progress="<?php echo esc_attr( $item['item_percent'] ); ?>">
                    <p class="progress-num text-caption">
                        <span class="counter">
                            <span class="number" data-speed="1500"
                                data-to="<?php echo esc_attr( $item['item_percent'] ); ?>">10</span>
                            %
                        </span>
                    </p>
                </div>
        ...
        <?php // Thêm đường kẻ line ngoại trừ item cuối cùng
                        if ( $index < count( $settings['tech_list'] ) - 1 ) : ?>
        <li class="br-line"></li>
        <?php endif; ?>
