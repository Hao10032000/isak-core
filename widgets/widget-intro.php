...
<?php class TFIntro_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Intro', 'themesflat-core' );
    }
...
public function get_script_depends() {
    return [ 
        // 1. Thư viện bổ trợ (Independent Libraries)
        'infinityslide',
        'countto',
        'change-text',

        // 2. GSAP Core (Gốc - Phải load trước các plugin của nó)
        'gsap', 

        // 3. Các Plugin của GSAP (Dependencies)
        'ScrollTrigger',   // BẮT BUỘC: Phải có vì gsapAnimation.js đang gọi nó
        'ScrollToPlugin',
        'ScrollSmooth', 
        'ScrollSmoother',
        'ScrollSmoother',

        // 4. Code logic tùy chỉnh (Chạy sau khi đã có đủ thư viện)
        'SplitText' ,
        'gsapAnimation',   // File này chứa code khởi tạo animation
        'main',
        'swiper-bundle',
        'SplitText'            // Thường chứa code khởi tạo chung của theme
    ];
}
                ...
                <div class="section-intro flat-spacing">
                                <div class="intro-author effectFade fadeUp no-div">
                                    ...
                                    <div class="author-info letter-space--05">
                                        ...
                                        <p class="info_duty text-black-50 text-body-3">UI Designer & No-Code Developer
                                        </p>
                                    </div>
                                </div>
                                <h1 class="intro-title letter-space--2 split-text effect-blur-fade">
                                    I’m building
                                    <span class="">websites</span><br>
                                    <span class="type-2">& brands</span>
                                ...
                                <div class="box-counter effectFade fadeUp no-div">
                                    ...
                                    <div class="wg-counter">
                                        <p class="counter h1 d-flex font-2 letter-space--2">
                                            <span class="number" data-speed="1000" data-to="6">0</span>
                                            x
                                        </p>
                                        <p class="text text-black-56 text-body-3">
                                            Industry Awards
            ...
            <?php elseif ( 'type-2' === $style ) : ?>
               <div  class="section-intro type-2 flat-spacing">
                                <h1 class="s-title text-black-72 letter-space--2 split-text effect-blur-fade">
                                    Start building <br class="d-none d-sm-block">
                                    websites & brands <br class="d-none d-sm-block">
                                    people remember
                                </h1>
                                ...
                                <div class="flip-image-list gsap-anime-2">
                                    <div class="flip-image">
                                        <img loading="lazy" width="300" height="300" src="assets/images/section/flip-1.jpg" alt="Image">
                                    </div>
                                    <div class="flip-image">
                                        <img loading="lazy" width="300" height="300" src="assets/images/section/flip-2.jpg" alt="Image">
                                    </div>
                                    <div class="flip-image">
                                        <img loading="lazy" width="300" height="300" src="assets/images/section/flip-3.jpg" alt="Image">
                                    </div>
                                    <div class="flip-image">
                                        <img loading="lazy" width="300" height="300" src="assets/images/section/flip-4.jpg" alt="Image">
                                    </div>
                                    <div class="flip-image">
                                        <img loading="lazy" width="300" height="300" src="assets/images/section/flip-5.jpg" alt="Image">
                                    </div>
                                    <div class="flip-image">
                                        <img loading="lazy" width="300" height="300" src="assets/images/section/flip-6.jpg" alt="Image">
                                    </div>
                                </div>
                                <p class="intro-client letter-space--05 text-body-3">
                                    Our clients (2015-25©)
                 ...
                 <div  class="section-intro type-3 flat-spacing">
                                ...
                                <div class="counter-image-item">
                                    ...
                                    <div class="image-item">
                                        <div class="image">
                                            <img class="image-switch" data-dark="assets/images/logo/logo-3d_dark.png" loading="lazy" width="543"
                                                height="403" src="assets/images/logo/logo-3d.png" alt="Image">
                                        </div>
